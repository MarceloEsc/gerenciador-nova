...
<Toolbar>
      ...
      <template #center v-if="props.type === 'manutencao'">
            <Button icon="pi pi-times" @click="cancelImportWatch('arquivoExcel')" severity="contrast" rounded="true" outlined="true"
            style="border: 0; margin-right: 10px" v-if="excelPages[0].label != 'Vazio'" />
